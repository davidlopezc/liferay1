...
public interface SubmissionLocalService extends BaseLocalService,
	...
	public Submission addSubmission(long assignmentId, long studentId,
		String submissionText, ServiceContext serviceContext)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Submission fetchSubmissionByUuidAndGroupId(String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Submission> getSubmissionsByUuidAndCompanyId(String uuid,
		long companyId);
