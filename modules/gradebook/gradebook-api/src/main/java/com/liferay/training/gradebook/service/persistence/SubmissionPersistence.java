...
public interface SubmissionPersistence extends BasePersistence<Submission> {
	...
	*/
	public java.util.List<Submission> findByUuid(String uuid, int start, int end);
	...
	*/
	public java.util.List<Submission> findByUuid(String uuid, int start,
		int end,
	...
	* @return the matching submissions
	*/
	public java.util.List<Submission> findByS_A(long studentId,
		long assignmentId);
