...
public class SubmissionLocalServiceUtil {
	...
	*/
	public static com.liferay.training.gradebook.model.Submission fetchSubmissionByUuidAndGroupId(
	...
	*/
	public static com.liferay.training.gradebook.model.Submission getSubmissionByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.training.gradebook.model.Submission> getSubmissionsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<com.liferay.training.gradebook.model.Submission> getSubmissionsByUuidAndCompanyId(
		...
		return getService()
				   .getSubmissionsByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	...
	static {
		...
		ServiceTracker<SubmissionLocalService, SubmissionLocalService> serviceTracker =
			new ServiceTracker<SubmissionLocalService, SubmissionLocalService>(bundle.getBundleContext(),
				SubmissionLocalService.class, null);
