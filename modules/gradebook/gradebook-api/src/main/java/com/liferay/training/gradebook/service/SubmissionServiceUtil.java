...
public class SubmissionServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<SubmissionService, SubmissionService> serviceTracker = new ServiceTracker<SubmissionService, SubmissionService>(bundle.getBundleContext(),
				SubmissionService.class, null);
