...
public class AssignmentLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<AssignmentLocalService, AssignmentLocalService> serviceTracker =
			new ServiceTracker<AssignmentLocalService, AssignmentLocalService>(bundle.getBundleContext(),
				AssignmentLocalService.class, null);
