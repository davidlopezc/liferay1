...
public abstract class SubmissionLocalServiceBaseImpl
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Submission>() {
				@Override
	...
	public List<Submission> getSubmissionsByUuidAndCompanyId(String uuid,
		...
		return submissionPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
