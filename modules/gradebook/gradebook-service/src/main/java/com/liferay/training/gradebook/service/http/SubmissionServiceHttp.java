...
public class SubmissionServiceHttp {
	...
	public static com.liferay.training.gradebook.model.Submission gradeSubmission(
		...
		try {
			MethodKey methodKey = new MethodKey(SubmissionServiceUtil.class,
					"gradeSubmission", _gradeSubmissionParameterTypes6);
	...
	public static com.liferay.training.gradebook.model.Submission updateSubmission(
		HttpPrincipal httpPrincipal, long submissionId, String submissionText,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {
		try {
			MethodKey methodKey = new MethodKey(SubmissionServiceUtil.class,
					"updateSubmission", _updateSubmissionParameterTypes7);
	...
	private static final Class<?>[] _getSubmissionsByAssignmentParameterTypes2 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[] _getSubmissionsByAssignmentParameterTypes3 = new Class[] {
			long.class, long.class, int.class, int.class
		};
	private static final Class<?>[] _getSubmissionsCountByAssignmentParameterTypes4 =
		new Class[] { long.class, long.class };
	private static final Class<?>[] _gradeAndCommentSubmissionParameterTypes5 = new Class[] {
			long.class, int.class, String.class
		};
	private static final Class<?>[] _gradeSubmissionParameterTypes6 = new Class[] {
			long.class, int.class
		};
	private static final Class<?>[] _updateSubmissionParameterTypes7 = new Class[] {
